...
Route::prefix('api')->group(function () {
    ...
    Route::middleware('api.token')->group(function () {
        ...
        Route::prefix('posts')->group(function () {
            ...
            Route::get('/tag/{tag}', function ($tagSlug) {
                $tag = \App\Models\Tag::where('slug', $tagSlug)->firstOrFail();
                $posts = $tag->posts()->with('user', 'category')->get();
    ...
    // Tag routes
    Route::get('/tags', [TagController::class, 'index']); // Public for autocomplete
    Route::post('/tags', [TagController::class, 'store']); // Protected for creation
});
